...
#assign bands
source = r"I:\GEOG 676\Lab 7"
band1 = arcpy.sa.Raster(source + r"\SI_band1.TIF") #blue
band2 = arcpy.sa.Raster(source + r"\SI_band2.TIF") #green
band3 = arcpy.sa.Raster(source + r"\SI_band3.TIF") #red
band4 = arcpy.sa.Raster(source + r"\SI_band4.TIF") #NIR
